...
export const newlyCreatedRoadmap: Roadmap = {
  roadmapID: 'f2efba7e-3561-465a-8945-75618875778e',
  title: 'Inspiratie',
  description: 'De weg naar succes voor Codidact, binnen deze roadmap zijn modules toegevoegd op basis van de resultaten van de behoefte analyse',
  modules: [
    {
...
export const existingRoadmapIndexData = [
  {
